...
def __main():
    ...
    parser.add_argument("-s", action='store_true', help='Use a proxy from the file /files/proxylist.txt for each request')
...
if __name__ == '__main__':
    ...
    parse = __main()
    _run(parse.l, parse.d, parse.p, parse.w, parse.s)
